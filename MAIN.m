...
% To process specific regions, list them
...
logMessage("Brain regions (regex patterns) defined.", logFilePath, 'INFO');
...
%% Populate Structured Data Containers and Save
...
%% Filter out Subjects Missing LFP from Any Selected Brain Region
...
%% Move Original metaData.mat to Recycle Directory
...
%% Run Theta Burst Feature Extraction via Python
